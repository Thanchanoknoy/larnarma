  ...
  <body>
    <div class="container-fluid">
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr><td><img src="images/img32.jpg" alt="" width="600" height="80"></td> </tr>
          </table>
      ...
      <br><br>   
                  ...
                  <div class="col-md-offset-4 col-md-4">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Username" aria-describedby="basic-addon1" name="txtuser" required>
                     </div>
                    </div>
                  </div>
            </div><br>
                  ...
                  <div class="col-md-offset-4 col-md-4">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" placeholder="Password" aria-describedby="basic-addon1"name="txtpassword" required>
                        </div>
                    </div>
                  </div>
            </div><br>
            <div class="row">
                  <div class="col-md-offset-4 col-md-4">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">Name&nbsp;&emsp;</span>
                            <input type="text" class="form-control" placeholder="Name" aria-describedby="basic-addon1" name="txtname" required>
                        </div>
                    </div>
                  </div>
            </div><br>
                  ...
                  <div class="col-md-offset-4 col-md-4">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Surname" aria-describedby="basic-addon1"name="txtsurname" required>
                        </div>
                    </div>
                  </div>
            </div><br>
                  ...
                  <div class="col-md-offset-4 col-md-4">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Address" aria-describedby="basic-addon1"name="txtaddress" required>
                        </div>
                    </div>
                  </div>
            </div><br>
                  ...
                  <div class="col-md-offset-4 col-md-4">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Phone" aria-describedby="basic-addon1"name="txtphone" required>
                        </div>
                    </div>
                  </div>
            </div><br>
                  ...
                  <div class="col-md-offset-4 col-md-4">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="E-mail" aria-describedby="basic-addon1"name="txtemail" required>
                        </div>
                    </div>
                  </div>
            </div>
